...
--
-- Host: localhost    Database: question3
-- ------------------------------------------------------
...
CREATE TABLE `feeding_schedule` (
  `schudule_id` int NOT NULL AUTO_INCREMENT,
  `animal_id` int NOT NULL,
  `food` char(50) NOT NULL,
  `feeding_time` time NOT NULL,
  PRIMARY KEY (`schudule_id`),
  KEY `animal_id` (`animal_id`),
  CONSTRAINT `feeding_schedule_ibfk_1` FOREIGN KEY (`animal_id`) REFERENCES `animal` (`animal_id`)
...
-- Dump completed on 2025-05-19 12:35:09
